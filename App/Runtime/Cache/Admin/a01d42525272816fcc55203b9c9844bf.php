...
<section id="main-content">
    <section class="wrapper">
        <h3><i class="fa fa-angle-right"></i>教学环境</h3>

        <!-- BASIC FORM ELELEMNTS -->
        <div class="row mt">
            <div class="col-lg-12">
                <div class="form-panel">
                    <h4 class="mb"><i class="fa fa-angle-right"></i><?php if($info['id']): ?>修改详情信息<?php else: ?>添加详情<?php endif; ?></h4>
                    <form class="form-horizontal style-form" method="post" action="/admin.php/Environment/dodata" enctype="multipart/form-data">
                        <input type="hidden" name="id" value="<?php echo ($info["id"]); ?>">
                        <div class="form-group">
                            <label class="col-sm-2 col-sm-2 control-label">原始图片</label>
                            <div class="col-sm-10">
                                <img src="<?php echo ($info["pic"]); ?>" width="150px" height="100px"><span style='color: red'>上传图片大小352*258</span>
                            </div>
                        </div>
                    ...
                    <form class="form-horizontal style-form" method="post" action="/admin.php/Environment/dodata1" enctype="multipart/form-data">
                        <input type="hidden" name="id" value="<?php echo ($info["id"]); ?>">
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <select name="cates">  
                                    <option value ="校园设施" <?php if($info["cates"] == '校园设施'): ?>selected="selected"<?php endif; ?>>校园设施</option>  
                                    <option value ="宿舍环境"  <?php if($info["cates"] == '宿舍环境'): ?>selected="selected"<?php endif; ?>>宿舍环境</option>  
                                    <option value="校园餐厅" <?php if($info["cates"] == '校园餐厅'): ?>selected="selected"<?php endif; ?>>校园餐厅</option>  
                                    <option value="新生入伍" <?php if($info["cates"] == '新生入伍'): ?>selected="selected"<?php endif; ?>>新生入伍</option>  
                                    <option value="女生练功图片" <?php if($info["cates"] == '女生练功图片'): ?>selected="selected"<?php endif; ?>>女生练功图片</option>  
                                </select>
                            </div>
                        </div>
