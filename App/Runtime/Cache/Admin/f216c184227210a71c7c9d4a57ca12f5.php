        ...
        <div class="row">
            <div class="col-md-12 mt">
                <div class="content-panel">
                    <h4><i class="fa fa-angle-right"></i>课程安排图集</h4>
                    <a style="margin-left:10%;" href="/admin.php/Company/addEditPics" class="btn btn-danger">添加详情</a>
                    <hr>
                    <?php if(empty($data)): ?><table class="table table-hover">
                        ...
                        <table class="table table-hover">
                            ...
                            <?php if(is_array($data)): foreach($data as $key=>$vo): ?><tr>
                                    ...
                                    <td>
                                        <a href="/admin.php/Company/pics_info/id/<?php echo ($vo["id"]); ?>" class="btn btn-info">查看</a>
                                        <a href="/admin.php/Company/addEditPics/id/<?php echo ($vo["id"]); ?>" class="btn btn-success">修改</a>
                                        <a href="/admin.php/Company/delPics/id/<?php echo ($vo["id"]); ?>" class="btn btn-danger" onclick="return firm(this);">删除</a>
                                    </td>
