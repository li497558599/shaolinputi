...
<section id="main-content">
    <section class="wrapper">
        <h3><i class="fa fa-angle-right"></i>家长问答</h3>

        <!-- BASIC FORM ELELEMNTS -->
        <div class="row mt">
            <div class="col-lg-12">
                <div class="form-panel">
                    <h4 class="mb"><i class="fa fa-angle-right"></i>修改家长问答</h4>
                    <form class="form-horizontal style-form" method="post" action="/admin.php/Question/update_news" enctype="multipart/form-data">
                        <input type="hidden" name="id" value="<?php echo ($id); ?>">

                        <div class="form-group">
                            <label class="col-sm-2 col-sm-2 control-label">原始图片</label>
                            <div class="col-sm-10">
                                <img width="200" height="150" src="<?php echo ($info["pic"]); ?>" alt="图片"><span style='color: red'>上传图片大小352*258</span>
                            </div>
                    ...
                    <form class="form-horizontal style-form" method="post" action="/admin.php/Question/change_news1" enctype="multipart/form-data">
                        <input type="hidden" name="id" value="<?php echo ($id); ?>">
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="dis" value="<?php echo ($info["dis"]); ?>" style="width:50%" class="form-control">
                            </div>
                        </div>
                          <div class="form-group">
                            <label class="col-sm-2 col-sm-2 control-label">作者</label>
                            <div class="col-sm-10">
                                <input type="text" name="author" value="<?php echo ($info["author"]); ?>" style="width:50%" class="form-control">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                ...
                                <script id="editor" type="text/plain" name="content" value="" style="width:1024px;height: 500px"><?php echo ($info["content"]); ?></script>
                            </div>
                        </div>
                        <button type="submit" style="width:30%;margin-left:17%;" class="btn btn-success">确认修改</button>
                    </form>
                </div>
            </div><!-- col-lg-12-->      	
        </div><!-- /row -->
...
<script type="text/javascript">
    function send()
    {
        var url = "/admin.php/News/update_news";
        var data = {};
        data.title = $("input[name='title']").val();
        data.dis = $("input[name='dis']").val();
        ...
        $.post(url, data, function (res) {
            res = JSON.parse(res);
            if (res.status == 1) {
                layer.alert(res.msg, {icon: 6, btn1: function () {
