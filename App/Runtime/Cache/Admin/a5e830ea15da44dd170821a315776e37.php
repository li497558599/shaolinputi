...
<section id="main-content">
    <section class="wrapper">
        <h3><i class="fa fa-angle-right"></i>招生简章</h3>
        ...
        <div class="row mt">
            <div class="col-lg-12">
                <div class="form-panel">
                    ...
                    <form class="form-horizontal style-form" action="/admin.php/Zhaosheng/update" method="post" enctype="multipart/form-data">
                        <input type="hidden" name="id" value="<?php echo ($info["id"]); ?>">
                        <div class="form-group">
                            <label class="col-sm-2 col-sm-2 control-label">原始图片</label>
                            <div class="col-sm-10">
                                <img src="<?php echo ($info["pic"]); ?>" width="150px" height="100px">
                            </div>
                        </div>
                        <!--</if>-->
                        <div class="form-group">
                    ...
                    <form class="form-horizontal style-form" action="/admin.php/Zhaosheng/update1" method="post" enctype="multipart/form-data">
                        <input type="hidden" name="id" value="<?php echo ($info["id"]); ?>">
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="description1" value="<?php echo ($info["description1"]); ?>" style="width:50%" class="form-control">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 col-sm-2 control-label">首页内容</label>
                            <div class="col-sm-10">
                                ...
                                <script id="editor" type="text/plain" name="description" value="" style="width:800px;height:500px;"><?php echo ($info["description"]); ?></script>
                            </div>
                        </div>
                        <!--                         <if condition="$info">-->
