            ...
            <div class="row mt">
              <div class="col-lg-12">
                  <div class="form-panel">
                      ...
                      <form class="form-horizontal style-form" method="post" action="/admin.php/Lbpics/sy_insert" enctype="multipart/form-data">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  <input type="text" name="dis" style="width:50%" class="form-control">
                              </div>
                          </div>
                              <button type="submit" style="width:30%;margin-left:17%;" class="btn btn-primary btn-lg btn-block">确认添加</button>
                      </form>
                  </div>
              </div><!-- col-lg-12-->       
            </div><!-- /row -->
