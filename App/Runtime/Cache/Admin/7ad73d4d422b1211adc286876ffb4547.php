        ...
        <div class="row mt">
            <div class="col-lg-12">
                <div class="form-panel">
                    <h4 class="mb"><i class="fa fa-angle-right"></i>修改信息</h4>
                    <form class="form-horizontal style-form" method="post" action="/admin.php/Admin/update_info" enctype="multipart/form-data">
                        <div class="form-group">
                            <label class="col-sm-2 col-sm-2 control-label">原始头像</label>
                            <div class="col-sm-10">
                    ...
                    <form class="form-horizontal style-form" method="post" action="/admin.php/Admin/update_info2" enctype="multipart/form-data">

                        <div class="form-group">
                            <label class="col-sm-2 col-sm-2 control-label">用户名</label>
                            <div class="col-sm-10">
                                <input type="text" name="username" value="<?php echo ($info["username"]); ?>" style="width:50%" class="form-control">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 col-sm-2 control-label">性别</label>
                            <div class="col-sm-10">
                                <input type="radio" name="sex" value="男" <?php if($info["sex"] == '男'): ?>checked="checked"<?php endif; ?>>&nbsp;男
                                &nbsp;&nbsp;&nbsp;&nbsp;
                                <input type="radio" name="sex" value="女" <?php if($info["sex"] == '女'): ?>checked="checked"<?php endif; ?>>&nbsp;女
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 col-sm-2 control-label">年龄</label>
                            <div class="col-sm-10">
                                <input type="text" name="years" value="<?php echo ($info["years"]); ?>" style="width:50%" class="form-control">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 col-sm-2 control-label">电话</label>
                            <div class="col-sm-10">
                                <input type="text" name="phone" value="<?php echo ($info["phone"]); ?>" style="width:50%" class="form-control">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 col-sm-2 control-label">邮箱</label>
                            <div class="col-sm-10">
                                <input type="text" name="email" value="<?php echo ($info["email"]); ?>" style="width:50%" class="form-control">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 col-sm-2 control-label">QQ</label>
                            <div class="col-sm-10">
                                <input type="text" name="qq" value="<?php echo ($info["qq"]); ?>" style="width:50%" class="form-control">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 col-sm-2 control-label">微信</label>
                            <div class="col-sm-10">
                                <input type="text" name="wechat" value="<?php echo ($info["wechat"]); ?>" style="width:50%" class="form-control">
                            </div>
                        </div>
                        <button type="submit" style="width:30%;margin-left:17%;" class="btn btn-primary btn-lg btn-block">确认修改</button>
                    </form>
                </div>
            </div><!-- col-lg-12-->      	
        </div><!-- /row -->
