            ...
            <div class="row mt">
              <div class="col-lg-12">
                  <div class="form-panel">
                      <h4 class="mb"><i class="fa fa-angle-right"></i>修改轮播图</h4>
                      <form class="form-horizontal style-form" method="post" action="/admin.php/Lbpics/sy_update" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
                              ...
                              <div class="col-sm-10">
                               ...
                               <div class="form-group">
                                ...
                                <button style="width:30%;margin-left:17%;" type="submit" class="btn btn-primary btn-lg btn-block">确认修改</button>
                                </form>
                  </div>
              </div><!-- col-lg-12-->       
            </div><!-- /row -->
