        ...
        <div class="row mt">
            <div class="col-lg-12">
                <div class="form-panel">
                    ...
                    <form class="form-horizontal style-form" method="post" action="/admin.php/Work/doPics" enctype="multipart/form-data">
                    ...
                    <form class="form-horizontal style-form" method="post" action="/admin.php/Work/doPics1" enctype="multipart/form-data">
                        <input type="hidden" name="id" value="<?php echo ($info["id"]); ?>">
                        <div class="form-group">
