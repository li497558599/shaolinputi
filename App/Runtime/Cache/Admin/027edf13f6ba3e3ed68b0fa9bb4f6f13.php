        ...
        <div class="row mt">
            <div class="col-lg-12">
                <div class="form-panel">
                    ...
                    <form class="form-horizontal style-form" method="post" action="/admin.php/Shoufei/dodata" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  ...
                                  <script id="editor" type="text/plain" name="content" value="" style="width:800px;height:500px;"><?php echo ($info["content"]); ?></script>
                              </div>
                          </div>
