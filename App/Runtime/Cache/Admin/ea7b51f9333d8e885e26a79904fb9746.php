				...
				<div class="row">
            	                  <div class="col-md-12">
            	                  	  <div class="content-panel">
            	                  	  	  <h4><i class="fa fa-angle-right">网站配置</i></h4>
            	                  	  	  <hr>
            		                      <table class="table">
            		                          <thead>
                                                    <tr>
                                                        <th>logo</th><th><img width="500" height="150" src="<?php echo ($info["pic"]); ?>" alt="图片"></th>
                                                    </tr>
                		                          <tr>
                		                              <th>网站状态</th><?php if($info["turn"] == 1): ?><th style="font-size:28px;">开启中</th><?php else: ?><th style="font-size:28px;">关闭中</th><?php endif; ?>
                		                          </tr>
                                                    <tr>
                                                        <th>网站名称</th><th style="font-size:28px;"><?php echo ($info["name"]); ?></th>
                                                    </tr>
                                                     <tr>
                                                        <th>网站地址</th><th style="font-size:28px;"><?php echo ($info["webAdre"]); ?></th>
                                                    </tr>
                                                    <tr>
                                                        <th>网站标题</th><th style="font-size:28px;"><?php echo ($info["title"]); ?></th>
                                                    </tr>
                                                    <tr>
                                                        <th>网站关键字</th><th style="font-size:28px;"><?php echo ($info["keywords"]); ?></th>
                                                    </tr>
                                                    <tr>
                                                        <th>网站描述</th><th style="font-size:28px;"><?php echo ($info["discription"]); ?></th>
                                                    </tr>
            		                          </thead>
            		                      </table>
            	                  	  </div>
