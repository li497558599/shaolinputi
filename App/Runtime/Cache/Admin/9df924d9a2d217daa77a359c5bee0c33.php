      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper">
            <h3 style="text-align: center;color:red;">欢迎您！管理员！</h3>
        <div class="row">
                                <div class="col-md-12">
                                    <div class="content-panel">
                                      ...
                                      <table class="table">
                                          <thead>
                                              <tr>
                                                  <th>当前登录：</th><th style="font-size:28px;"><?php echo (session('adminusername')); ?></th>
                                              </tr>
                                              <tr>
                                                  <th>当前IP：</th><th style="font-size:28px;"><?php echo ($loc["ip"]); ?></th>
                                              </tr>
                                                    <tr>
                                                        <th>登录地址：</th><th style="font-size:28px;"><?php echo ($loc["country"]); ?> <?php echo ($loc["province"]); ?> <?php echo ($loc["city"]); ?></th>
                                                    </tr>
                                                    <tr>
                                                        <th>登录日期：</th><th style="font-size:28px;"><?php echo ($time); ?></th>
                                                    </tr>
                                                    <tr>
                                                        <th>注册时间：</th><th style="font-size:28px;"><?php echo ($info["ctime"]); ?></th>
                                                    </tr>
                                          </thead>
                                      </table>
                                    </div>
