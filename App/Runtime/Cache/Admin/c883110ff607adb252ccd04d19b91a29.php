        ...
        <div class="row">
            <div class="col-md-12 mt">
                <div class="content-panel">
                    <h4><i class="fa fa-angle-right"></i>问题列表</h4>
                    <form class="form-inline" role="form" method="get" action="/admin.php/Question/news/<?php echo ($keywords); ?>">
                        <div class="form-group">
                            <label class="sr-only" for="exampleInputPassword2">输入问题标题搜索</label>
                        ...
                        <a style="margin-left:10%;" href="/admin.php/Question/add_news" class="btn btn-danger">添加问题</a>
                    </form>
                    <hr>
                    ...
                    <?php if(empty($data)): ?><table class="table table-hover">
                        ...
                        <table class="table table-hover">
                            ...
                            <?php if(is_array($data)): foreach($data as $key=>$vo): ?><tr>
                                    ...
                                    <td>
                                        <a href="/admin.php/Question/news_info/id/<?php echo ($vo["id"]); ?>" class="btn btn-info">查看</a>
                                        <a href="/admin.php/Question/change_news/id/<?php echo ($vo["id"]); ?>" class="btn btn-success">修改</a>
                                        <a href="/admin.php/Question/delete_news/id/<?php echo ($vo["id"]); ?>" class="btn btn-danger" onclick="return firm(this);">删除</a>
                                    </td>
