        ...
        <div class="row mt">
            <div class="col-lg-12">
                <div class="form-panel">
                    ...
                    <form class="form-horizontal style-form" action="/admin.php/Company/update" method="post" enctype="multipart/form-data">
                    ...
                    <form class="form-horizontal style-form" action="/admin.php/Company/update2" method="post" enctype="multipart/form-data">
                        <input type="hidden" name="id" value="<?php echo ($info["id"]); ?>">
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="description2" value="<?php echo ($info["description2"]); ?>" style="width:50%" class="form-control">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 col-sm-2 control-label">首页内容</label>
                            <div class="col-sm-10">
                                <textarea type="text" name="description" value="" style="width:40%;height: 200px;" class="form-control"><?php echo ($info["description"]); ?></textarea>
                            </div>
                        </div>
