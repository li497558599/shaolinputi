...
<section id="main-content">
    <section class="wrapper">
        <h3><i class="fa fa-angle-right"></i>报名管理</h3>
        <div class="row">
            <div class="col-md-12 mt">
                <div class="content-panel">
                    <h4><i class="fa fa-angle-right"></i>在线报名</h4>
                    <hr>
                    <?php if(empty($data)): ?><table class="table table-hover">
                        ...
                        <table class="table table-hover">
                            ...
                            <?php if(is_array($data)): foreach($data as $key=>$vo): ?><tr>
                                    ...
                                    <td style="font-size:18px;"><?php echo ($vo["phone"]); ?></td>
                                    <td style="font-size:18px;"><?php echo ($vo["years"]); ?></td>
                                    <td style="font-size:18px;"><?php echo ($vo["content"]); ?></td>
                                    <td style="font-size:18px;"><?php echo ($vo["ctime"]); ?></td>
                                    <td>
                                        <a href="/admin.php/Report/delete_online/id/<?php echo ($vo["id"]); ?>" class="btn btn-danger" onclick="return firm(this);">删除</a>
                                    </td>
