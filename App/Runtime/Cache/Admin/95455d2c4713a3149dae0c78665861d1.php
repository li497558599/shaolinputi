          ...
          <section class="wrapper">
          	...
          	<div class="row mt">
                  ...
                  <div class="form-panel">
                  	  <h4 class="mb"><i class="fa fa-angle-right"></i>修改简章</h4>
                      <form class="form-horizontal style-form" action="/admin.php/Zhaosheng/update_dis" method="post" enctype="multipart/form-data">
