        ...
        <div class="row mt">
            <div class="col-lg-12">
                <div class="form-panel">
                    <h4 class="mb"><i class="fa fa-angle-right"></i><?php if($info['id']): ?>修改图片<?php else: ?>添加图片<?php endif; ?></h4>
                    <form class="form-horizontal style-form" method="post" action="/admin.php/Company/doPics" enctype="multipart/form-data">
                        ...
                        <?php if($info): ?><div class="form-group">
                          ...
                          <span style='color: red'>上传图片大小352*258</span>
                    ...
                    <form class="form-horizontal style-form" method="post" action="/admin.php/Company/doPics1" enctype="multipart/form-data">
                        <input type="hidden" name="id" value="<?php echo ($info["id"]); ?>">
                        <div class="form-group">
                            <label class="col-sm-2 col-sm-2 control-label">名称</label>
                            <div class="col-sm-10">
                                <input class="form-control" name="name" value="<?php echo ($info["name"]); ?>" style="width:50%;"/>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 col-sm-2 control-label">描述</label>
                            <div class="col-sm-10">
                                <textarea class="form-control" name="dis" style="width:50%;height:150px;"><?php echo ($info["dis"]); ?></textarea>
                    ...
                    <button type="submit" style="width:30%;margin-left:17%;" class="btn btn-theme03">确认修改</button>
                    </form>
                </div>
            </div><!-- col-lg-12-->      	
        </div><!-- /row -->
