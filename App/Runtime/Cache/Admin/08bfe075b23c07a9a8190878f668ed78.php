				...
				<div class="row">
            	                  <div class="col-md-12">
            	                  	  <div class="content-panel">
            	                  	  	  <h4><i class="fa fa-angle-right"></i>招生简章</h4>
            	                  	  	  <hr>
            		                      <table class="table">
            		                          <thead>
                                                    <tr>
                                                        <th></th><th><a href="/admin.php/Zhaosheng/change_dis" class="btn btn-theme03">修改简章</a></th>
                                                    </tr>
                                                    <tr>
                                                        <th></th><th><h1><?php echo ($info["profile"]); ?></h1></th>
                                                    </tr>
