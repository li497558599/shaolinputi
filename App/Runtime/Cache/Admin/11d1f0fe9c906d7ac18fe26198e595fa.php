        ...
        <div class="row mt">
            <div class="col-lg-12">
                <div class="form-panel">
                    <h4 class="mb"><i class="fa fa-angle-right"></i>内容简介</h4>
                    <form class="form-horizontal style-form" action="/admin.php/Environment/update_dis" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                ...
                                <script id="editor" type="text/plain" name="dis" value="" style="width:1150px;height:500px;"><?php echo ($info["dis"]); ?></script>
                            </div>
                        </div>
