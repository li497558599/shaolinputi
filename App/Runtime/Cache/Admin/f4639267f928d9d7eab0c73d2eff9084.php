            	                  ...
            	                  <div class="col-md-12">
            	                  	  <div class="content-panel">
            		                      ...
            		                      <table class="table">
            		                          <thead>
                                                    <tr>
                                                        <th>头像</th><th><img width="200" height="150" src="<?php echo ($info["pic"]); ?>" alt="图片"></th>
                                                    </tr>
                		                          <tr>
                		                              <th>用户名</th><th style="font-size:28px;"><?php echo ($info["username"]); ?></th>
                		                          </tr>
                                                    <tr>
                                                        <th>性别</th><th style="font-size:28px;"><?php echo ($info["sex"]); ?></th>
                                                    </tr>
                                                    <tr>
                                                        <th>年龄</th><th style="font-size:28px;"><?php echo ($info["years"]); ?></th>
                                                    </tr>
                                                    <tr>
                                                        <th>电话</th><th style="font-size:28px;"><?php echo ($info["phone"]); ?></th>
                                                    </tr>
                                                     <tr>
                                                        <th>邮箱</th><th style="font-size:28px;"><?php echo ($info["email"]); ?></th>
                                                    </tr>
                                                     <tr>
                                                        <th>QQ</th><th style="font-size:28px;"><?php echo ($info["qq"]); ?></th>
                                                    </tr>
                                                    <tr>
                                                        <th>微信</th><th style="font-size:28px;"><?php echo ($info["wechat"]); ?></th>
                                                    </tr>
                                                    <tr>
                                                        <th>管理时间</th><th style="font-size:28px;"><?php echo ($info["ctime"]); ?> 始</th>
                                                    </tr>
            		                          </thead>
            		                      </table>
            	                  	  </div>
