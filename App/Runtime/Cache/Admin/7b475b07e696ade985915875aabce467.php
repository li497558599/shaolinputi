...
<style>
  .page .current{color:#fff;background:#a94442;}
  .page{text-align: center;margin:20px 0 !important;}
  .page p{display: inline-block;float: none !important;position: relative;top: -8px;}  
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-angle-right"></i>新闻资讯</h3>
				<div class="row">
	                  <div class="col-md-12 mt">
	                  	<div class="content-panel">
                              <h4><i class="fa fa-angle-right"></i>资讯列表</h4>
                                <form class="form-inline" role="form" method="get" action="/admin.php/News/news/<?php echo ($keywords); ?>">
                                    <div class="form-group">
                                        <label class="sr-only" for="exampleInputPassword2">输入新闻资讯标题搜索</label>
                                        <input style="width:500px;" type="text" name="keywords" value="<?php echo ($_GET['keywords']); ?>" class="form-control" id="exampleInputPassword2" placeholder="输入问题标题搜索">
                                    </div>
                                    <button type="submit" class="btn btn-theme02">搜 索</button>
                                    <a style="margin-left:10%;" href="/admin.php/News/add_news" class="btn btn-danger">添加新闻资讯</a>
                                </form>
                              
                              
                                <hr>
                                <?php if(empty($data)): ?><table class="table table-hover">
                                                <thead>
                                                <tr>
                                                    <th style="text-align: center;font-size: 28px;">没有任何结果！</th>
                                                </tr>
                                                </thead>
                                            </table>
                                <?php else: ?>
                                              <table class="table table-hover">
                                                    ...
                                                    <tbody>
                                                              <?php if(is_array($data)): foreach($data as $key=>$vo): ?><tr>
                                                                      <td style="font-size:18px;"><?php echo ($vo["id"]); ?></td>
                                                                      <td style="font-size:18px;"><?php echo ($vo["title"]); ?></td>
                                                                     <td><img width="100" height="70" src="<?php echo ($vo["pic"]); ?>" alt="图片"></td>
                                                                     <td style="font-size:18px;"><?php echo ($vo["author"]); ?></td>
                                                                      <td style="font-size:18px;"><?php echo ($vo["ctime"]); ?></td>
                                                                      <td>
                                                                              <a href="/admin.php/News/news_info/id/<?php echo ($vo["id"]); ?>" class="btn btn-info">查看</a>
                                                                              <a href="/admin.php/News/change_news/id/<?php echo ($vo["id"]); ?>" class="btn btn-success">修改</a>
                                                                              <a href="/admin.php/News/delete_news/id/<?php echo ($vo["id"]); ?>" class="btn btn-danger" onclick="return firm(this);">删除</a>
                                                                      </td>
                                   ...
                                   <div class="page">
                                                     <?php echo ($page); ?>
                                                <p class='num'>共 <?php echo ($num); ?> 条</p>
                                                </div><?php endif; ?>
	                  </div><!-- /col-md-12 -->
				</div><!-- row -->
