				...
				<div class="row">
	                  <div class="col-md-12 mt">
	                  	<div class="content-panel">
                              <h4><i class="fa fa-angle-right"></i>收费标准</h4>
                              <a style="margin-left:10%;" href="/admin.php/Shoufei/addEditInfo" class="btn btn-danger">添加详情</a>
                              <hr>
                                              ...
                                              <table class="table table-hover">
                                                    ...
                                                    <tbody>
                                                              <?php if(is_array($data)): foreach($data as $key=>$vo): ?><tr>
                                                                      ...
                                                                      <td style="font-size:18px;"><?php echo (mb_substr($vo["dis"],0,20,'utf-8')); ?></td>
                                                                      <td style="font-size:18px;"><?php echo ($vo["ctime"]); ?></td>
                                                                      <td>
                                                                              <a href="/admin.php/Shoufei/addEditInfo/id/<?php echo ($vo["id"]); ?>" class="btn btn-success">修改</a>
                                                                              <a href="/admin.php/Shoufei/del/id/<?php echo ($vo["id"]); ?>" class="btn btn-danger" onclick="return firm(this);">删除</a>
                                                                      </td>
