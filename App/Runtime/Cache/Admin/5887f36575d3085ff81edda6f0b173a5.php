            ...
            <div class="col-md-12">
                <div class="content-panel">
                    <table class="table">
                        <thead>
                            <tr>
                                <th>武校简介<a style='margin-left: 100px' href="/admin.php/Company/dis" class="btn btn-theme04">查看详情</a></th><th></th>
                            </tr>

                            <tr>
                                <th>网站标题</th><th style="font-size:23px;"><?php echo ($info["title"]); ?></th>
                            </tr>
                            <tr>
                                <th>网站关键字</th><th style="font-size:23px;"><?php echo ($info["keywords"]); ?></th>
                            </tr>
                             <tr>
                                <th>描述</th><th style="font-size:20px;"><?php echo ($info["description2"]); ?></th>
                            </tr>

                            <tr>
                                <th>首页内容</th><th style="font-size:20px;"><?php echo ($info["description"]); ?></th>
                            </tr>
                           
                            <tr>
                                <th>图片</th><th style="font-size:23px;">  <img src="<?php echo ($info["pic"]); ?>" width="150px" height="100px">  </th>
                            </tr>
<!--                            <tr>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <script id="editor" type="text/plain" name="profile" value="" style="width:1024px;height:500px;"><?php echo ($info["profile"]); ?></script>
                                    </div>
                                </div>
                        </tr>-->
                        <tr>
                            <th style="width:10%;"></th><th><a style="width:30%;" href="/admin.php/Company/change" class="btn btn-success">修改</a></th>
                        </tr>
                        </thead>
                    </table>
                </div>
