        ...
        <div class="row">
            <div class="col-md-12">
                <div class="content-panel">
                    <h4 class="mb"><i class="fa fa-angle-right"></i>招生简介</h4>
                    <table class="table">
                        <thead>
                            <tr>
                                <th>修改简介<a style='margin-left: 100px' href="/admin.php/Zhaosheng/dis" class="btn btn-theme04">查看详情</a></th><th></th>
                            </tr>
                            ...
                            <tr>
                                <th>网站描述</th><th style="font-size:23px;"><?php echo ($info["description1"]); ?></th>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <th style="width:10%;"></th><th><a style="width:30%;" href="/admin.php/Zhaosheng/change" class="btn btn-success">修改</a></th>
                            </tr>
                        </thead>
                    </table>
                </div>
