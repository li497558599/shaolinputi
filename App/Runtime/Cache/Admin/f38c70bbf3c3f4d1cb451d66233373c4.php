...
<section id="main-content">
    <section class="wrapper">
        <h3><i class="fa fa-angle-right"></i>毕业去向</h3>

        <!-- BASIC FORM ELELEMNTS -->
        <div class="row mt">
            <div class="col-lg-12">
                <div class="form-panel">
                    <h4 class="mb"><i class="fa fa-angle-right"></i>毕业简介</h4>
                    <form class="form-horizontal style-form" action="/admin.php/Work/update_dis" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                ...
                                <script id="editor" type="text/plain" name="content" value="" style="width:1024px;height:500px;"><?php echo ($info["dis"]); ?></script>
                            </div>
                        </div>
...
<script>
    ...
    $(document).ready(function () {
        ...
        setInterval(function () {
            var w1 = $("#edui1_iframeholder").width();
            var w2 = $("#edui1_iframeholder img").width();
            if (w2 > w1) {
                $("#edui1_iframeholder img").addClass("max");
            }
        }, 1000)
    })
