          ...
          <section class="wrapper">
          	...
          	<div class="row mt">
                  ...
                  <div class="form-panel">
                  	  <h4 class="mb"><i class="fa fa-angle-right"></i>课程简介</h4>
                      <form class="form-horizontal style-form" action="/admin.php/Company/update_clasDis" method="post" enctype="multipart/form-data">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  ...
                                  <script id="editor" type="text/plain" name="content" value="" style="width:1024px;height:500px;"><?php echo ($info["clasdis"]); ?></script>
                              </div>
                          </div>
