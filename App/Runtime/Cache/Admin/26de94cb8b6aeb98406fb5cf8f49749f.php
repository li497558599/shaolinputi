        ...
        <div class="row mt">
            <div class="col-lg-12">
                <div class="form-panel">
                    ...
                    <form class="form-horizontal style-form" action="/admin.php/Company/update1" method="post" enctype="multipart/form-data">
                         <input type="hidden" name="id" value="<?php echo ($info["id"]); ?>">

                          <div class="form-group">
                            <label class="col-sm-2 col-sm-2 control-label">原始图片</label>
                            <div class="col-sm-10">
                                <img width="200" height="150" src="<?php echo ($info["pic1"]); ?>" alt="图片">
                            </div>
                        ...
                        <div class="form-group">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  <input type="text" name="address" value="<?php echo ($info["address"]); ?>" style="width:50%" class="form-control">
                              </div>
                          </div>
                          <div class="form-group">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  <input type="text" name="mobile" value="<?php echo ($info["mobile"]); ?>" style="width:50%" class="form-control">
                              </div>
                          </div>
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">备案号</label>
                              <div class="col-sm-10">
                                  <input type="text" name="banum" value="<?php echo ($info["banum"]); ?>" style="width:50%" class="form-control">
                              </div>
                          </div>
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">审批号</label>
                              <div class="col-sm-10">
                                  <input type="text" name="spnum" value="<?php echo ($info["spnum"]); ?>" style="width:50%" class="form-control">
                              </div>
                          </div>
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">办公电话</label>
                              <div class="col-sm-10">
                                  <input type="text" name="bphone" value="<?php echo ($info["bphone"]); ?>" style="width:50%" class="form-control">
                              </div>
                          </div>
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">咨询手机</label>
                              <div class="col-sm-10">
                                  <input type="text" name="zxmobile" value="<?php echo ($info["zxmobile"]); ?>" style="width:50%" class="form-control">
                              </div>
                          </div>
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">微信</label>
                              <div class="col-sm-10">
                                  <input type="text" name="weixin" value="<?php echo ($info["weixin"]); ?>" style="width:50%" class="form-control">
                              </div>
                          </div>
