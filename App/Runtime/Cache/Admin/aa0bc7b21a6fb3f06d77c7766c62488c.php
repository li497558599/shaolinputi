        ...
        <div class="row">
            <div class="col-md-12 mt">
                <div class="content-panel">
                    <h4><i class="fa fa-angle-right"></i>首页轮播图</h4>
                    <hr>
                    <?php if(empty($data)): ?><table class="table table-hover">
                        ...
                        <table class="table table-hover">
                            ...
                            <?php if(is_array($data)): foreach($data as $key=>$vo): ?><tr>
                                    ...
                                    <td style="font-size:18px;"><?php echo ($vo["dis"]); ?></td>
                                    <td style="font-size:18px;"><?php echo ($vo["ctime"]); ?></td>
                                       <td style="font-size:18px;"><?php echo ($vo["cates"]); ?></td>
                                    <td>
                                        <a href="/admin.php/Lbpics/sy_change/id/<?php echo ($vo["id"]); ?>" class="btn btn-success">修改</a>
                                        <a href="/admin.php/Lbpics/sy_delete/id/<?php echo ($vo["id"]); ?>" class="btn btn-danger" onclick="return firm(this);">删除</a>
                                    </td>
