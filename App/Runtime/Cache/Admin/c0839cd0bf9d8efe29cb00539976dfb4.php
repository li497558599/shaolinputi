                ...
                $(document).ready(function () {
                    ...
                    if (title1 === "") {
                        ...
                        if (title1 === "个人中心") {
                            ...
                            title1 = 11;
                        } else if (title1 === "轮播图管理") {
                            title1 = 12;
                        } else if (title1 === "底部导航链接地址") {
                            title1 = 13;
                        }

                        if (title2 === "我的信息" || title2 === "网站配置" || title2 === "体系列表" || title2 === "武校简介" || title2 === "招生简介" || title2 === "收费简介" || title2 === "课程简介" || title2 === "内容简介" || title2 === "问题列表" || title2 === "毕业简介" || title2 === "咨询列表" || title2 === "免费回电" || title2 === "首页轮播图" || title2 === "链接地址") {
                            title2 = 0;
                        } else if (title2 === "修改信息" || title2 === "修改配置" || title2 === "添加体系" || title2 === "联系方式" || title2 === "收费标准" || title2 === "课程安排" || title2 === "校园风采" || title2 === "毕业去向" || title2 === "在线报名" || title2 === "添加轮播图") {
                            title2 = 1;
                        } else if (title2 === "修改密码" || title2 === "客场安排图集" || title2 === "毕业图集") {
                            title2 = 2;
                        }
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-angle-right"></i>网站管理</h3>
          	
          	<!-- BASIC FORM ELELEMNTS -->
          	<div class="row mt">
          		<div class="col-lg-12">
                  <div class="form-panel">
                  	  <h4 class="mb"><i class="fa fa-angle-right"></i>修改配置</h4>
                      <form class="form-horizontal style-form" method="post" action="/admin.php/Config/upload" enctype="multipart/form-data">
                      <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">原始logo</label>
                              <div class="col-sm-10">
                                  <img width="200" height="150" src="<?php echo ($info["pic"]); ?>" alt="图片">
                              </div>
                          </div>
                               <div class="form-group">
                                    <label class="col-sm-2 col-sm-2 control-label">上传logo</label>
                                    <div class="col-sm-10">
                                        <input type="file" name="pic">
                                    </div>
                                    <button style="margin-left: 15%;" type="submit" class="btn btn-theme02"><i class="fa fa-check"></i>确认上传</button>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 col-sm-2 control-label">网站开关</label>
                                    <div class="col-sm-10">
                                        <input type="radio" name="turn" value="1" <?php if($info["turn"] == 1): ?>checked="checked"<?php endif; ?>>&nbsp;开
                                        &nbsp;&nbsp;&nbsp;&nbsp;
                                        <input type="radio" name="turn" value="0" <?php if($info["turn"] == 0): ?>checked="checked"<?php endif; ?>>&nbsp;关
                                    </div>
                                </div>
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">网站名称</label>
                              <div class="col-sm-10">
                                  <input type="text" name="name" value="<?php echo ($info["name"]); ?>" style="width:50%" class="form-control">
                              </div>
                          </div>
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">网站地址</label>
                              <div class="col-sm-10">
                                  <input type="text" name="webAdre" value="<?php echo ($info["webAdre"]); ?>" style="width:50%" class="form-control">
                              </div>
                          </div>
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">网站标题</label>
                              <div class="col-sm-10">
                                  <input type="text" name="title" value="<?php echo ($info["title"]); ?>" style="width:50%" class="form-control">
                              </div>
                          </div>
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">网站关键字</label>
                              <div class="col-sm-10">
                                  <input type="text" name="keywords" value="<?php echo ($info["keywords"]); ?>" style="width:50%" class="form-control">
                              </div>
                          </div>
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">网站描述</label>
                              <div class="col-sm-10">
                                  <input type="text" name="discription" value="<?php echo ($info["discription"]); ?>" style="width:50%" class="form-control">
                              </div>
                          </div>
                              <a style="width:30%;margin-left:17%;" class="btn btn-primary btn-lg btn-block" onclick="send()">确认修改</a>
                      </form>
                  </div>
          		</div><!-- col-lg-12-->      	
          	</div><!-- /row -->
      ...
      <script type="text/javascript">
        function send()
        {
          var url = "/admin.php/Config/update";
          var data = {};
          data.name = $("input[name='name']").val();
          data.turn = $("input[type='radio']:checked").val();
          data.webAdre = $("input[name='webAdre']").val();
          data.title = $("input[name='title']").val();
          data.keywords = $("input[name='keywords']").val();
          data.discription = $("input[name='discription']").val();
          $.post(url,data,function(res){
                  res = JSON.parse(res);
                  if(res.status == 1){
                             layer.alert(res.msg,{icon:6,btn1:function(){window.location.href=res.url;}});
                  }else{
