...
<head>
	<meta charset="UTF-8" />
	<meta name="Keywords" content="<?php echo ($bydis["keywords"]); ?>"/>
            <meta name="Description" content="<?php echo ($bydis["description1"]); ?>"/>
	<meta name="viewport" id="viewport" content="width=device-width, initial-scale=1, user-scalable=no">
	 <title><?php echo ($bydis["title"]); ?></title>
...
<!--<div class="consultation">
	...
	<div class="con course">
		<h2><u><img src="/Public/Mobile/img/index-03.png"/>毕业去向</u><span>位置：首页>毕业去向</span></h2>
		<ul>
