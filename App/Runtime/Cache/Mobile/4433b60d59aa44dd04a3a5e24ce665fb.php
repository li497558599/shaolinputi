...
<html lang="en">
    <head>
        ...
        <title><?php echo ($question1["title"]); ?></title>
...
<!--<div class="consultation">
    ...
    <div class="con news-in">
        ...
        <h3><?php echo ($question1["title"]); ?></h3>
        <h4><span>作者：<?php echo ($question1["author"]); ?></span>
            <span>点击量：<?php echo ($question1["visit"]); ?></span>
            <span>时间：<?php echo ($question1["ctime"]); ?></span></h4>
        <p>
            <?php echo ($question1["content"]); ?>
        </p>
        <!--<p><img src="img/index-16-05.png"/></p>-->
        <?php if(!empty($preshow)): ?><h5><a href="/Question/question_in/id/<?php echo ($preshow["id"]); ?>">上一篇：<?php echo ($preshow["title"]); ?></a></h5><?php endif; ?>
        <?php if(!empty($nextshow)): ?><h5><a href="/Question/question_in/id/<?php echo ($nextshow["id"]); ?>">下一篇：<?php echo ($nextshow["title"]); ?></a></h5><?php endif; ?>
    </div>
    <!--首页版权信息部分-->
<div class="foot">
    <p>
