...
<head>
	<meta charset="UTF-8" />
	<meta name="Keywords" content="<?php echo ($clasdis["keywords"]); ?>"/>
	<meta name="Description" content="<?php echo ($clasdis["description"]); ?>"/>
	<meta name="viewport" id="viewport" content="width=device-width, initial-scale=1, user-scalable=no">
	<title><?php echo ($clasdis["title"]); ?></title>
...
<!--<div class="consultation">
	...
	<div class="con course">
		<h2><u><img src="/Public/Mobile/img/index-03.png"/>课程安排</u><span>位置：首页>课程安排</span></h2>
                <p>
                                       <?php echo ($clasdis["clasdis"]); ?>
    				</p>
