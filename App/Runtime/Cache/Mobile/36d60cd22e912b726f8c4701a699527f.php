...
<!--<div class="consultation">
	...
	<div class="con charge">
		<h2><u><img src="/Public/Mobile/img/index-03.png"/>收费标准</u><span>位置：首页>收费标准</span></h2>
                <?php if(is_array($sfinfo)): foreach($sfinfo as $key=>$vo): ?><p> <?php echo ($shoufei["dis"]); ?></p><?php endforeach; endif; ?>
