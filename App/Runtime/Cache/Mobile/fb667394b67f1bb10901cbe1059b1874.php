...
<html lang="en">
    <head>
        <meta charset="UTF-8" />
        <meta name="Keywords" content="<?php echo ($zhaosheng["keywords"]); ?>"/>
        <meta name="Description" content="<?php echo ($zhaosheng["description1"]); ?>"/>
        <meta name="viewport" id="viewport" content="width=device-width, initial-scale=1, user-scalable=no">
        <title><?php echo ($zhaosheng["title"]); ?></title>
...
<!--<div class="consultation">
    ...
    <!--子页面内容开始-->
    <div class="con student">
        <h2><u><img src="/Public/Mobile/img/index-03.png"/>招生简章</u><span>位置：首页>招生简章</span></h2>
        <p>
            <?php echo ($zhaosheng["profile"]); ?>
        </p>
