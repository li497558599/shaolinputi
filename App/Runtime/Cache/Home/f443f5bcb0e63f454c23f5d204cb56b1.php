...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <meta charset="UTF-8">
            <title>河南嵩山少林寺武术学校|文武学校招生常见问题解答</title>
            <meta name="Keywords" content="少林寺武校家长问答,河南嵩山少林寺武术学校家长问答"/>
            <meta name="Description" content="河南嵩山少林寺武术学校对于学生在校时,对家长提出的一些问题及所关心的问题进行汇编总结,少林寺文武学校给与统一答复，更多有关武校相关问题请拨打24小时招生咨询热线：18703898345。"/>
...
<!--                <form action="<?php echo U('Home/Index/online');?>" method="post">-->
        ...
        <div class="right question">
            <h2 class="title1">
                <u>家长问答</u>
                <span>当前位置：<a href="/">网站首页</a>><a href="news">家长问答</a></span>
            </h2>
            <h3 class="title2">家长问答</h3>
            <ul class="list1">
                <?php if(is_array($question)): foreach($question as $key=>$vo): ?><li>
                        <h3><a href="/question_in/<?php echo ($vo["id"]); ?>"<u><?php echo ($vo["title"]); ?></u></a><span>时间：<?php echo ($vo["ctime"]); ?></span></h3>
                        <p><?php echo (mb_substr($vo["dis"],0,80,utf8)); ?></p>
                    </li><?php endforeach; endif; ?>

            </ul>
            <div class="page">
                <?php echo ($page); ?>
                <!--<span>共<b>20</b>页<b><?php echo ($count); ?></b>条</span>-->
            </div>
        </div>
        </div>
        </div>
