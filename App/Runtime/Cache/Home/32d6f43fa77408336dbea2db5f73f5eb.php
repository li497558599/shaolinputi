...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <!--banner下方的回拨电话-->
            <div class="banner-02">
                <div class="mid">
                    <span class="s1">嵩山少林寺文武招生官网2017年暑期招生报名全面开启！现在可提前报名预留名额！</span>
                    <input type="text" name="phone" class="myphone" value="" placeholder="请输入您的电话号码"/>
                    <button onclick="return check11()" >免费回拨电话</button>
                </div>
            </div>
        <!--武校简介内容开始-->
        <div class="about">
            <div class="mid">
                <div class="left">
                    ...
                    <div class="list4">
                           <p><u>学员姓名：</u><input type="text"  class="myname" name="name" placeholder="必填"/></p>
                            ...
                            <p><button onclick="return check9()">提交信息</button></p>
                    </div>
                </div>
                ...
                <div class="right">
                    <h2 class="title1">
                        <u>教学体系</u>
                        <span>当前位置：<a href="/">网站首页</a>><a href="/question">教学体系</a></span>
                    </h2>
                    <h3 class="title2"><?php echo ($products["name"]); ?></h3>

                    <h4 class="t3" style="text-align:center">
                        <!--<span>作者：<?php echo ($products["author"]); ?></span>-->
                        <span>点击量：<?php echo ($products["visit"]); ?></span>
                        <span>时间：<?php echo ($products["ctime"]); ?></span>
                    </h4>
