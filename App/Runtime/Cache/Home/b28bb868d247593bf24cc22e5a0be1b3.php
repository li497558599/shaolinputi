...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <meta charset="UTF-8">
            <title><?php echo ($news1["title"]); ?></title>
            <meta name="Keywords" content="<?php echo ($news1["keywords"]); ?>"/>
            <meta name="Description" content="<?php echo ($news1["dis"]); ?>"/>
...
<!--                <form action="<?php echo U('Home/Index/online');?>" method="post">-->
        ...
        <div class="right news">
            <h2 class="title1">
                <u>新闻资讯</u>
                <span>当前位置：<a href="/">网站首页</a>><a href="news">新闻资讯</a></span>
            </h2>
            <ul class="list1">
                <li <?php if(!$ac): ?>class="active"<?php endif; ?>><a href="news">全部新闻</a></li>
                <li <?php if($ac == '武校新闻'): ?>class="active"<?php endif; ?>><a href="/news/cates=武校新闻">武校新闻</a></li>

                <li <?php if($ac == '媒体新闻'): ?>class="active"<?php endif; ?>><a href="/news/cates=媒体新闻">媒体新闻</a></li>

                <li <?php if($ac == '少林资讯'): ?>class="active"<?php endif; ?>><a href="/news/cates=少林资讯">少林资讯</a></li>
                <li <?php if($ac == '学院军训'): ?>class="active"<?php endif; ?>><a href="/news/cates=学院军训">学院军训</a></li>
            </ul>
            <ul class="list2">
                <?php if(is_array($cates1)): foreach($cates1 as $key=>$vo): ?><li>
                        <div class="pic">
                            <img src="<?php echo ($vo["pic"]); ?>"/>
                        </div>
                        <div class="word">
                            <h2><a href="/news_in/<?php echo ($vo["id"]); ?>"><?php echo ($vo["title"]); ?></a><span><?php echo ($vo["ctime"]); ?></span></h2>
                            <p><?php echo ($vo["dis"]); ?></p>
                        </div>
