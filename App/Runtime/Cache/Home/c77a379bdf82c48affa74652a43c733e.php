...
<!--                <form action="<?php echo U('Home/Index/online');?>" method="post">-->
        ...
        <div class="right">
            <h2 class="title1">
                <u>家长关心</u>
                <span>当前位置：<a href="/">网站首页</a>><a href="/question">家长关心</a></span>
            </h2>

            <h3 class="title2"><?php echo ($question1["title"]); ?></h3>
            
            <h4 class="t3" style="text-align:center">
                <span>作者：<?php echo ($question1["author"]); ?></span>
                <span>点击量：<?php echo ($question1["visit"]); ?></span>
                <span>时间：<?php echo ($question1["ctime"]); ?></span>
            </h4>
         

            <p><?php echo ($question1["content"]); ?></p>
        </div>
        </div>
        </div>
