...
<!--                <form action="<?php echo U('Home/Index/online');?>" method="post">-->
        ...
        <div class="right sign_up">
            <h2 class="title1">
                <u>在线报名</u>
                <span>当前位置：<a href="/">网站首页</a>><a href="">在线报名</a></span>
            </h2>
            <h3 class="title2">在线报名</h3>
            <form action="<?php echo U('Home/Index/online');?>" method="post">
                <p><u>学员姓名：</u><input type="text"  name="name" placeholder="必填"/></p>
                <p><u>联系电话：</u><input type="text" name="years" placeholder="必填"/></p>
                <p><u>微信/qq号：</u><input type="text" name="phone" placeholder="选填"/></p>
                <p><u>留言内容：</u><textarea name="content" placeholder="选填"></textarea></p>
